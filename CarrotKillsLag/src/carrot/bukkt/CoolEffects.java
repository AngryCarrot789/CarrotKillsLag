...
public final class CoolEffects {
    ...
    public static void SpawnDelayedLightningBats(Player player){
        try{
            ...
            Bukkit.getScheduler().scheduleSyncDelayedTask(CarrotKillsLag.instance, new Runnable() {
                @Override
                public void run() {
    ...
    public static String RainbowText(String text){
        ...
        for(int i = 0; i < text.length(); i++) {
            ...
            switch (number) {
                ...
                case 2: buffer += ChatColor.AQUA + String.valueOf(character); break;
                case 3: buffer += ChatColor.BLUE + String.valueOf(character); break;
                case 4: buffer += ChatColor.GREEN + String.valueOf(character); break;
                case 5: buffer += ChatColor.LIGHT_PURPLE + String.valueOf(character); break;
